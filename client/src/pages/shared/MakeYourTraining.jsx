...
export default function CreateTrainingPlan() {
  ...
  const addMuscle = () => {
    if (
      ...
      !selectedMuscles.includes(selectedMuscleInfo.name)
    ) {
      setSelectedMuscles((prev) => [...prev, selectedMuscleInfo.name]);
    }
  };

  const removeMuscle = (muscleToRemove) => {
    setSelectedMuscles((prevMuscles) =>
      prevMuscles.filter((muscle) => muscle !== muscleToRemove)
    );
  };
        ...
        <div className="svg-container max-w-[400px] mr-8">
          ...
          >
            <g id="muscles-front">
              ...
              <g
                className="muscle middle-deltoideus"
              ...
              <g
                className="muscle front-deltoideus"
              ...
              <g
                className="muscle upper-trapezius"
        ...
        <div className="svg-container max-w-[400px] mr-8">
          ...
          >
            <g id="muscles-back">
              ...
              <g
                className="muscle rear-deltoideus"
