...
export default function CreateTrainingPlan() {
  ...
  return (
    <div id="wrapper" className="w-full bg-black text-white font-sans p-8">
      <div className="flex justify-evenly mb-10">
        ...
        <div id="plan-details" className="mb-10">
          ...
          <div className="mb-4 flex flex-col" id="plan-times-per-week">
            <label for="times-per-week">How many trainings per week?</label>
            <input
              type="number"
              id="times-per-week"
              name="times-per-week"
      ...
      <section id="trainingDays" className="mb-10">
        ...
        <div className="flex gap-4">
          {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((day) => (
            <div
              key={day}
              className="border px-4 py-2 cursor-pointer hover:bg-red-700"
            >
              {day}
            </div>
          ))}
      ...
      <div id="muscle-select" className="flex">
        <div class="svg-container max-w-[400px] mr-8">
          <svg
          ...
          >
            <g id="muscles-front">
              ...
              <g
                class="muscle abdominals"
                data-muscle="Rectus Abdominis"
                data-name="Abdominals"
              >
                <path
                  class="cls-2"
                  d="M239.8,352.32c-3.2,1.2-14.3,6.3-15.7.9l-.3-4.5a242.61,242.61,0,0,1-.1-31.9,6.44,6.44,0,0,1,1.2-3.9c1.3-1.5,2.9-1.6,4.9-.3,7,4.6,11.4,15.8,15.3,25.5C247.9,345.22,246.1,349.92,239.8,352.32Z"
                />
                <path
                  class="cls-2"
                  d="M190.8,344.32c3.4-9.6,8-24.7,17.5-29.1a2.89,2.89,0,0,1,3.8,1.4,1.42,1.42,0,0,1,.2.6c2.6,11.9,1,26.1.7,38.1a3.76,3.76,0,0,1-3.8,3.6h-.5C202,357.62,187.2,354.42,190.8,344.32Z"
                />
                <path
                  class="cls-2"
                  d="M228.9,398.72a5.53,5.53,0,0,1-4.4,0,2.24,2.24,0,0,1-1.2-1.9v-28.4a4.38,4.38,0,0,1,2.6-4,66,66,0,0,1,19.4-5.4,4,4,0,0,1,4.4,3.2c2,9.8,5,21.4-4.8,28.4A66.87,66.87,0,0,1,228.9,398.72Z"
                />
                <path
                  class="cls-2"
                  d="M182.2,388.92l2.6-16a7.62,7.62,0,0,1,8.6-6.3l12,1.7a7.63,7.63,0,0,1,6.6,7.4l.5,20.3a7.6,7.6,0,0,1-7.4,7.8,10.47,10.47,0,0,1-3-.5l-15.1-6A7.76,7.76,0,0,1,182.2,388.92Z"
                />
                <path
                  class="cls-2"
                  d="M249,425.12c-5.4,4.5-13.6,9-20.7,10.2-2.1.4-3.2-.5-3.2-2.7-.1-5.6-.2-11.3-.4-17.1-.2-3.9,1.7-6.1,4.8-8a124.84,124.84,0,0,1,18.4-9,4.21,4.21,0,0,1,5.4,2.3c.1.4.2.7.3,1.1C254.3,410.22,257,418.42,249,425.12Z"
                />
                <path
                  class="cls-2"
                  d="M206.4,412.32c4.7,2,7.5,3.3,8,9a69.2,69.2,0,0,1-.6,17,1.29,1.29,0,0,1-1.2,1.2c-8.6,1.1-34.9-1-33.4-15.1.6-5.2-.3-19.5,8.4-18.1A93.09,93.09,0,0,1,206.4,412.32Z"
                />
                <path
                  class="cls-2"
                  d="M255.3,446.92c-2.9,15.9-13.2,33-24.6,43.4a4.32,4.32,0,0,1-4.4.8,1,1,0,0,1-.8-1.2c.3-10.5.1-20.9-.6-31.3-.8-11.5,3.8-13.4,14.1-17C244.6,439.72,257.2,436.32,255.3,446.92Z"
                />
                <path
                  class="cls-2"
                  d="M193,486a24.21,24.21,0,0,1-9.2-21c.3-5.9.2-14.3,4-16.7,4.1-2.6,17.4,0,22.3,1.1,7.6,1.9,9.4,6.7,8.9,14.3-.5,6.7-.8,13.5-.9,20.2-.1,3.6.6,9.5-.2,14a3.26,3.26,0,0,1-3.8,2.5,6.89,6.89,0,0,1-.8-.3C205.9,496.52,199.3,491,193,486Z"
                />
              </g>
              <g
                class="muscle biceps"
              ...
              <g
                class="muscle middle-deltoideus"
        ...
        <div class="muscle-description">
          <p id="muscle-name">
            <strong>Muscle Name:</strong> <span id="muscle-name-value"></span>
          </p>
          <p id="latin-name">
            <strong>Latin Name:</strong> <span id="latin-name-value"></span>
          </p>
          <p id="muscle-desc">
            <strong>Description:</strong> <span id="muscle-desc-value"></span>
          </p>
          <p id="muscle-movements">
            <strong>Movements:</strong>{" "}
            <span id="muscle-movements-value"></span>
          </p>
          <button type="button" id="add-muscle-button">
            Add Muscle to Training
          </button>
        </div>
        <div id="selected-muscles">
          <h4 id="muscle-selection-heading">Muscle Selection for Monday</h4>
          <ul id="selected-muscles-list"></ul>
        </div>
        <button type="button" id="choose-exercises-button">
          Show exercises
        </button>
      </div>
    </div>
